...
if (myPin === pinCode.pincode) {
  ...
  if (menu.options === "Cash Withdraw") {
    ...
    if (withdrawAmount.withdrawamount <= myBalance) {
      console.log(
        `Transaction Successfull, Rs. `,
        withdrawAmount.withdrawamount
      );
      console.log(
        `Your remaining balance is ${myBalance - withdrawAmount.withdrawamount}`
      );
    } else {
  ...
  if (menu.options === "Cash Transfer") {
    ...
    if (transferAmount.transferamount <= myBalance) {
      console.log(
        `Successfully Transfered Rs.${transferAmount.transferamount} to ${transferAmount.transferTo}`
      );
      console.log(
        `Your remaining balance is Rs.${
          myBalance - transferAmount.transferamount
        }`
      );
    }
  }
